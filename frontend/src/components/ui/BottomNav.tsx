...
export const BottomNav = ({ activeTab, onTabChange }: BottomNavProps) => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100 px-2 py-1.5 z-50 safe-area-bottom">
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex flex-col items-center justify-center gap-0.5 p-1.5 rounded-xl transition-all duration-200 min-w-[60px]",
